const ProjectFullPath = process.env.ProjectFullPath || process.env.HOME + '/Projects/Proto';
...
module.exports = {
  ...
  findImage: function(imagePath, imageName, click) {
    var image_path = imagePath || ProjectFullPath + '/global/step_images/' + process.env.PLATFORM;
    var image_fullPath = image_path + '/' + imageName;
    var findImage_JS = ProjectFullPath + '/global/libs/find_image.js';
  ...
  clickImage: function(imagePath, imageName) {
    var image_path = imagePath || ProjectFullPath + '/global/step_images/' + process.env.PLATFORM;
    var image_fullPath = image_path + '/' + imageName;
    var clickImage_JS = ProjectFullPath + '/global/libs/click_image.js';
